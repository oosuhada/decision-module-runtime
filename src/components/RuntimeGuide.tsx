...
const steps = [
  { moduleId: 'evidence', title: 'Replace the reference evidence', body: 'Start in Decision brief or use IMPORT INPUTS in the request bar. Input packs replace evidence, source locators, options, weights, and budget together.' },
